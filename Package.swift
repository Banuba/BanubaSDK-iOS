...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "BanubaSdk",
      url: "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaSDK/1.53.0-beta.2/BanubaSdk-1.53.0-beta.2.xcframework.zip",
      checksum: "1af6a03057f7102b813c1dc97bd05e04a207adffd30d134ea057b998f4836698"
    ),
    .target(
